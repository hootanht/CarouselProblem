...
using CarouselProblem.Server;
using CarouselProblem.Server.Models.Identity;
using CarouselProblem.Server.Services;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "CarouselProblem.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "CarouselProblem.Shared.xml"));
