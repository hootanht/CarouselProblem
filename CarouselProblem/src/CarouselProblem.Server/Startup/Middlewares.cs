...
using System.Web;
using CarouselProblem.Client.Core.Services;
using CarouselProblem.Server.Components;
using HealthChecks.UI.Client;
using Microsoft.AspNetCore.Components.Endpoints;
using Microsoft.AspNetCore.Diagnostics.HealthChecks;
using Microsoft.AspNetCore.Http.Extensions;

namespace CarouselProblem.Server.Startup;
...
public class Middlewares
{
    ...
    public static void Use(WebApplication app, IHostEnvironment env, IConfiguration configuration)
    {
        ...
        var blazorApp = app.MapRazorComponents<App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("CarouselProblem") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
